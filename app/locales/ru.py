...
class Messages:
    ...
    AUTH_ACCESS_REQUEST_ALREADY_SENT = (
        "⏳ Заявка на авторизацию уже отправлена.\n\n"
        "Повторное уведомление администратора возможно не раньше чем через 24 часа. "
        "Дождитесь ответа или свяжитесь с администратором напрямую."
    )
    ...
    ACCESS_DENIED_ACTION = "Или нажмите кнопку, чтобы открыть чат с администратором:"
    ...
    ABOUT_SYSTEM = (
        ...
        "• После завершения проверки система сразу скачивает новый фид.\n"
        "• Проверка всех товаров и магазинов из каждого фида.\n"
        "• Максимальная длительность одного цикла — до 12 часов (лимит).\n"
        "• HTTP-проверки URL идут последовательно: интервал зависит от числа\n"
        "  страниц и изображений в обоих фидах.\n"
        "• В отчёте «плановое окончание» — оценка по оставшимся URL,\n"
        "  а не просто старт + 5 часов.\n"
