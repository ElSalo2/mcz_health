...
class Messages:
    ...
    AUTH_ACCESS_DENIED = (
        ...
        "Вы отправили свой номер для проверки.\n"
        "Для получения доступа напишите администратору:\n"
        "{admin_contact}\n\n"
        "Ниже — карточка контакта администратора (это не ваш профиль).\n"
        "После одобрения заявки снова откройте бот и нажмите «Авторизоваться»."
    )
    AUTH_USER_BLOCKED = (
    ...
    ABOUT_SYSTEM = (
        ...
        "• Максимальная длительность одной проверки — 5 часов.\n"
